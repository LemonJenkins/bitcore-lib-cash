...
var SignatureLib = require('../../crypto/signature');
...
Input.fromBufferReader = function(br, params) {
  ...
  if (params && params.hex) {
    ...
    var signatures = []
    if(params.publicKey){
      signatures = [Signature({prevTxId: input.prevTxId, outputIndex: input.outputIndex, inputIndex: 0, sigtype:SignatureLib.SIGHASH_FORKID, publicKey: params.publicKey, signature: sigString})]
    }
