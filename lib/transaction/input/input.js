...
Input.fromBufferReader = function(br, params) {
  ...
  if (params && params.hex) {
    ...
    if(params.publicKey){
      ...
      signatures[publicKeysString.indexOf(params.publicKey)] = Signature({prevTxId: input.prevTxId, outputIndex: input.outputIndex, inputIndex: 0, sigtype:65, publicKey: params.publicKey, signature: sigString})
    }
