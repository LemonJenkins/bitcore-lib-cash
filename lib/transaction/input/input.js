...
Input.fromBufferReader = function(br, params) {
  ...
  if (params && params.hex) {
    ...
    var signatures = new Array(2)
    if(params.publicKey){
      signatures[1] = Signature({prevTxId: input.prevTxId, outputIndex: input.outputIndex, inputIndex: 0, sigtype:1, publicKey: params.publicKey, signature: sigString})
    }
